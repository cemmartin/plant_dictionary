...
const PlantDetails = ({plant, onFavouriteSelect}) => {
    ...
    const favouriteBtnText = plant.isFavourite ? 'Remove from favourites' : 'Add to favourites'

    return (
    <>
        <h2>{plant["common_name"]}</h2>
        <img src={plant["default_image"]["small_url"]} alt={`Photo of ${plant["common_name"]}`}></img>
